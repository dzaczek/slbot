...
STYLES = {
    "Standard (Curriculum)": {
        ...
        "stages": {
            ...
            2: {
                "name": "WALL_AVOID",
                "gamma": 0.9241247487933149,
                "food_reward": 5.0,
                "food_shaping": 0.15,
                "survival": 0.3,
                "survival_escalation": 0.002,
                "death_wall": -45.86647363718661,
                "death_snake": -20,
                "wall_alert_dist": 2500,
                "wall_proximity_penalty": 1.5,
                "starvation_penalty": 0.007404877282151504,
            ...
            3: {
                ...
                "starvation_penalty": 0.008873654971363193,
            ...
            4: {
                ...
                "length_bonus": 0.02,
                "wall_proximity_penalty": 0.5504404793818558,
                "enemy_alert_dist": 2000,
                "enemy_proximity_penalty": 1.192421379272613,
                "enemy_approach_penalty": 0.632108844615989,
                "boost_penalty": 2.7310097492202883,
                "mass_loss_penalty": 5.40314730056099,
                "starvation_penalty": 0.16594672352537393,
            ...
            5: {
                ...
                "survival_escalation": 0.00066679511271336,
                "death_wall": -45,
                "death_snake": -50,
                "length_bonus": 0.05,
