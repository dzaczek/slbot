...
**Generated:** 2026-03-06 11:25:32  
**Total Episodes:** 46057  
...
### Critical Issues
- Rewards DECLINING: -4644.3

### Warnings
- Loss very high (12142.66) - unstable
...
| S5 | MASTERY_SURVIVAL | 16431 | -4120.2 | 428.1 | 112.9 | 0.5095 | 0.3% | 99.6% | 0.0% |

## Key Statistics

| Metric | Mean | Std | Min | P25 | Median | P75 | P95 | Max |
|--------|------|-----|-----|-----|--------|-----|-----|-----|
| Reward | -90.45 | 173397.22 | -18203767.65 | 327.11 | 860.88 | 2165.05 | 7951.50 | 166636.02 |
| Steps | 410.72 | 1309.76 | 1.00 | 102.00 | 236.00 | 507.00 | 1410.00 | 99999.00 |
| Food | 127.66 | 136.19 | 0.00 | 46.00 | 85.00 | 158.00 | 395.00 | 4532.00 |
| Loss | 9411566.08 | 110680085.84 | 0.00 | 16.95 | 88.86 | 469.71 | 17573094.80 | 12494751744.00 |
| Food/Step | 0.55 | 0.78 | 0.00 | 0.29 | 0.36 | 0.54 | 1.25 | 30.67 |

## Windowed Trend Analysis

| Window | Mean Reward | Std | Slope | R² |
|--------|-----------|-----|-------|----|
| Last 50 | 2277.95 | 3152.30 | +96.9614 | 0.1970 |
| Last 100 | 2267.40 | 2873.62 | +16.1487 | 0.0263 |
| Last 200 | 1907.02 | 2305.64 | +6.7302 | 0.0284 |
| Last 500 | 2215.12 | 2426.57 | -0.7819 | 0.0022 |
| Last 1000 | 1888.36 | 2013.97 | +0.9351 | 0.0180 |

## Death Cause Analysis

| Cause | Count | % | Avg Steps | Avg Reward |
|-------|-------|---|-----------|------------|
| Wall | 100 | 0.2% | 629.3 | 3331.5 |
| SnakeCollision | 43849 | 95.2% | 357.5 | 2072.0 |
| MaxSteps | 2086 | 4.5% | 1517.3 | -45722.7 |
...
**Total consultations:** 123  
**Most adjusted:** `lr` (54x), `enemy_proximity_penalty` (42x), `death_snake` (33x), `enemy_approach_penalty` (33x), `food_reward` (22x), `gamma` (19x), `length_bonus` (17x), `epsilon_target` (9x), `food_shaping` (9x), `survival` (7x), `boost_penalty` (7x), `target_update_freq` (2x), `wall_proximity_penalty` (1x)
