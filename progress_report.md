...
**Generated:** 2026-02-24 23:26:05  
**Total Episodes:** 27956  
...
### Warnings
- Loss very high (1741.43) - unstable

### Positive Signals
- Rewards improving: +1877.2
...
| S4 | MASS_MANAGEMENT | 23137 | 2225.8 | 413.9 | 142.8 | 0.5916 | 0.2% | 95.7% | 4.0% |
| S5 | MASTERY_SURVIVAL | 391 | 1472.1 | 257.8 | 90.3 | 0.4855 | 0.3% | 99.7% | 0.0% |

## Key Statistics

| Metric | Mean | Std | Min | P25 | Median | P75 | P95 | Max |
|--------|------|-----|-----|-----|--------|-----|-----|-----|
| Reward | 1909.61 | 6346.84 | -41038.86 | 220.27 | 647.78 | 1819.99 | 8294.28 | 166636.02 |
| Steps | 388.94 | 456.39 | 1.00 | 97.00 | 226.00 | 500.00 | 1512.25 | 2000.00 |
| Food | 133.16 | 150.87 | 0.00 | 45.00 | 86.00 | 163.00 | 436.00 | 4532.00 |
| Loss | 2511853.32 | 35403749.92 | 0.00 | 7.37 | 27.62 | 87.01 | 563.40 | 1444364672.00 |
| Food/Step | 0.58 | 0.80 | 0.00 | 0.30 | 0.38 | 0.60 | 1.35 | 30.67 |

## Windowed Trend Analysis

| Window | Mean Reward | Std | Slope | R² |
|--------|-----------|-----|-------|----|
| Last 50 | 7091.48 | 4905.13 | +69.7286 | 0.0421 |
| Last 100 | 6374.62 | 4859.70 | +30.0372 | 0.0318 |
| Last 200 | 5607.16 | 4508.38 | +18.5653 | 0.0565 |
| Last 500 | 2630.68 | 5176.92 | +17.3506 | 0.2340 |
| Last 1000 | 465.16 | 6226.91 | +11.9476 | 0.3068 |

## Death Cause Analysis

| Cause | Count | % | Avg Steps | Avg Reward |
|-------|-------|---|-----------|------------|
| Wall | 51 | 0.2% | 430.7 | 2996.6 |
| SnakeCollision | 25872 | 92.5% | 328.6 | 2035.7 |
| MaxSteps | 2017 | 7.2% | 1160.6 | 281.2 |
...
**Total consultations:** 92  
**Most adjusted:** `enemy_proximity_penalty` (41x), `death_snake` (33x), `lr` (33x), `enemy_approach_penalty` (32x), `food_reward` (19x), `gamma` (14x), `length_bonus` (13x), `epsilon_target` (6x), `boost_penalty` (6x), `food_shaping` (6x), `survival` (3x), `wall_proximity_penalty` (1x)
