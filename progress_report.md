...
**Generated:** 2026-02-24 15:17:51  
**Total Episodes:** 27502  
...
### Warnings
- Loss very high (443869129.12) - unstable

### Positive Signals
- Rewards improving: +1870.7
...
| S4 | MASS_MANAGEMENT | 22683 | 2215.4 | 413.2 | 143.2 | 0.5933 | 0.2% | 95.7% | 4.0% |
...
|--------|------|-----|-----|-----|--------|-----|-----|-----|
| Reward | 1895.82 | 6360.26 | -41038.86 | 216.80 | 635.63 | 1786.21 | 8167.53 | 166636.02 |
| Steps | 387.99 | 455.22 | 1.00 | 97.00 | 226.00 | 499.00 | 1506.00 | 2000.00 |
| Food | 133.33 | 151.31 | 0.00 | 45.00 | 86.00 | 163.00 | 436.95 | 4532.00 |
| Loss | 2548162.38 | 35693565.54 | 0.00 | 7.22 | 26.50 | 82.21 | 353.98 | 1444364672.00 |
...
|--------|-----------|-----|-------|----|
| Last 50 | 1505.38 | 1166.16 | -10.8984 | 0.0182 |
| Last 100 | 1531.54 | 1112.89 | -0.4636 | 0.0001 |
| Last 200 | 1577.77 | 1250.40 | -1.2672 | 0.0034 |
| Last 500 | -745.36 | 5688.71 | +20.7640 | 0.2776 |
| Last 1000 | -1985.07 | 6622.09 | +3.6728 | 0.0256 |
...
| SnakeCollision | 25441 | 92.5% | 328.0 | 2013.6 |
| MaxSteps | 1994 | 7.3% | 1151.0 | 380.8 |
...
**Most adjusted:** `enemy_proximity_penalty` (41x), `death_snake` (33x), `enemy_approach_penalty` (32x), `lr` (31x), `food_reward` (17x), `gamma` (14x), `length_bonus` (13x), `epsilon_target` (6x), `boost_penalty` (6x), `food_shaping` (5x), `survival` (3x), `wall_proximity_penalty` (1x)
