...
**Generated:** 2026-03-07 17:51:17  
**Total Episodes:** 48979  
...
| S5 | MASTERY_SURVIVAL | 19353 | -3187.3 | 440.5 | 121.7 | 0.5175 | 0.3% | 99.2% | 0.5% |

## Key Statistics

| Metric | Mean | Std | Min | P25 | Median | P75 | P95 | Max |
|--------|------|-----|-----|-----|--------|-----|-----|-----|
| Reward | 37.74 | 168146.92 | -18203767.65 | 338.96 | 884.42 | 2212.36 | 7757.14 | 166636.02 |
| Steps | 416.65 | 1276.63 | 1.00 | 104.00 | 240.00 | 518.00 | 1434.00 | 99999.00 |
| Food | 130.25 | 137.66 | 0.00 | 47.00 | 86.00 | 163.00 | 404.00 | 4532.00 |
| Loss | 8850307.56 | 107350959.92 | 0.00 | 15.18 | 90.20 | 620.06 | 14637272.20 | 12494751744.00 |
...
|--------|-----------|-----|-------|----|
| Last 50 | 1555.13 | 1661.53 | +34.6142 | 0.0904 |
| Last 100 | 2342.87 | 2325.94 | -19.3432 | 0.0576 |
| Last 200 | 2401.51 | 2282.88 | -1.4996 | 0.0014 |
| Last 500 | 2430.74 | 2216.30 | +0.0987 | 0.0000 |
| Last 1000 | 2022.79 | 1974.24 | +1.4510 | 0.0450 |

## Death Cause Analysis

| Cause | Count | % | Avg Steps | Avg Reward |
|-------|-------|---|-----------|------------|
| Wall | 110 | 0.2% | 673.9 | 3425.6 |
| SnakeCollision | 46674 | 95.3% | 363.9 | 2063.5 |
| MaxSteps | 2171 | 4.4% | 1536.2 | -43695.8 |
...
**Total consultations:** 126  
**Most adjusted:** `lr` (56x), `enemy_proximity_penalty` (42x), `death_snake` (33x), `enemy_approach_penalty` (33x), `food_reward` (22x), `gamma` (19x), `length_bonus` (17x), `epsilon_target` (10x), `food_shaping` (9x), `boost_penalty` (8x), `survival` (7x), `target_update_freq` (2x), `wall_proximity_penalty` (1x)
