...
**Generated:** 2026-03-06 20:40:49  
**Total Episodes:** 47580  
...
### Critical Issues
- Rewards DECLINING: -4402.9

### Warnings
- Loss very high (1268.89) - unstable
...
| S5 | MASTERY_SURVIVAL | 17954 | -3587.9 | 431.0 | 116.3 | 0.5159 | 0.3% | 99.6% | 0.0% |

## Key Statistics

| Metric | Mean | Std | Min | P25 | Median | P75 | P95 | Max |
|--------|------|-----|-----|-----|--------|-----|-----|-----|
| Reward | -18.59 | 170600.37 | -18203767.65 | 334.53 | 876.07 | 2194.72 | 7884.67 | 166636.02 |
| Steps | 412.40 | 1291.36 | 1.00 | 103.00 | 238.00 | 511.00 | 1409.05 | 99999.00 |
| Food | 128.45 | 136.10 | 0.00 | 47.00 | 85.00 | 160.00 | 397.00 | 4532.00 |
| Loss | 9110531.52 | 108906868.50 | 0.00 | 18.11 | 96.66 | 690.99 | 16315253.45 | 12494751744.00 |
...
|--------|-----------|-----|-------|----|
| Last 50 | 2161.56 | 2406.89 | -43.5451 | 0.0682 |
| Last 100 | 2434.97 | 2592.26 | -13.7645 | 0.0235 |
| Last 200 | 2442.22 | 2512.17 | -3.1927 | 0.0054 |
| Last 500 | 2207.90 | 2256.02 | +1.1439 | 0.0054 |
| Last 1000 | 2085.84 | 2111.29 | +0.2541 | 0.0012 |
...
| SnakeCollision | 45367 | 95.3% | 360.9 | 2074.5 |
| MaxSteps | 2086 | 4.4% | 1517.3 | -45722.7 |
...
**Total consultations:** 125  
**Most adjusted:** `lr` (55x), `enemy_proximity_penalty` (42x), `death_snake` (33x), `enemy_approach_penalty` (33x), `food_reward` (22x), `gamma` (19x), `length_bonus` (17x), `epsilon_target` (10x), `food_shaping` (9x), `boost_penalty` (8x), `survival` (7x), `target_update_freq` (2x), `wall_proximity_penalty` (1x)
