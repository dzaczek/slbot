...
### Warnings
- Loss very high (12.18) - unstable

### Positive Signals
- Rewards improving: +968.3
...
| S4 | MASS_MANAGEMENT | 3818 | 0.1 | 415.8 | 93.3 | 0.6103 | 0.1% | 93.2% | 6.7% |

## Key Statistics

| Metric | Mean | Std | Min | P25 | Median | P75 | P95 | Max |
|--------|------|-----|-----|-----|--------|-----|-----|-----|
| Reward | 159.13 | 2548.70 | -35299.32 | 120.81 | 302.26 | 605.33 | 1690.58 | 6098.01 |
| Steps | 337.64 | 413.03 | 1.00 | 90.00 | 215.00 | 407.00 | 1215.00 | 2000.00 |
| Food | 89.77 | 76.08 | 0.00 | 41.00 | 70.00 | 111.00 | 222.75 | 566.00 |
| Loss | 6.82 | 8.76 | 0.00 | 1.57 | 4.40 | 9.00 | 20.14 | 204.95 |
| Food/Step | 0.57 | 0.86 | 0.00 | 0.30 | 0.36 | 0.49 | 1.48 | 11.25 |

## Windowed Trend Analysis

| Window | Mean Reward | Std | Slope | R² |
|--------|-----------|-----|-------|----|
| Last 50 | 803.29 | 846.91 | +20.2347 | 0.1189 |
| Last 100 | 545.86 | 691.11 | +9.4135 | 0.1546 |
| Last 200 | 741.39 | 914.18 | -2.6414 | 0.0278 |
| Last 500 | 817.09 | 975.77 | -0.8984 | 0.0177 |
| Last 1000 | 925.87 | 1057.22 | -0.4460 | 0.0148 |
...
| SnakeCollision | 6896 | 83.6% | 261.3 | 494.3 |
| MaxSteps | 1334 | 16.2% | 730.9 | -1576.9 |
...
**Most adjusted:** `death_snake` (21x), `enemy_proximity_penalty` (18x), `enemy_approach_penalty` (12x), `epsilon_target` (5x), `lr` (2x), `gamma` (1x)
