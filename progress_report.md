...
**Generated:** 2026-02-19 16:45:25  
**Total Episodes:** 12196  
...
### Warnings
- Loss very high (75.40) - unstable

### Positive Signals
- Rewards improving: +1575.1
- Positive reward trend (slope=0.2464, R²=0.106)
...
| S4 | MASS_MANAGEMENT | 7768 | 919.7 | 441.5 | 117.9 | 0.5488 | 0.1% | 95.4% | 4.3% |

## Key Statistics

| Metric | Mean | Std | Min | P25 | Median | P75 | P95 | Max |
|--------|------|-----|-----|-----|--------|-----|-----|-----|
| Reward | 693.38 | 2661.01 | -35299.32 | 166.12 | 397.64 | 935.13 | 3667.48 | 33980.40 |
| Steps | 379.30 | 434.05 | 1.00 | 101.00 | 245.00 | 498.00 | 1372.50 | 2000.00 |
| Food | 106.57 | 96.45 | 0.00 | 46.00 | 78.00 | 131.00 | 308.00 | 630.00 |
| Loss | 10.71 | 16.26 | 0.00 | 2.53 | 6.44 | 12.62 | 32.23 | 279.64 |
| Food/Step | 0.55 | 0.80 | 0.00 | 0.29 | 0.35 | 0.47 | 1.33 | 11.25 |

## Windowed Trend Analysis

| Window | Mean Reward | Std | Slope | R² |
|--------|-----------|-----|-------|----|
| Last 50 | 6399.58 | 7931.16 | +95.5765 | 0.0302 |
| Last 100 | 4802.87 | 6335.56 | +53.1630 | 0.0587 |
| Last 200 | 4889.67 | 5585.68 | +5.1879 | 0.0029 |
| Last 500 | 4127.89 | 4898.58 | +5.1839 | 0.0233 |
| Last 1000 | 3022.73 | 3934.85 | +4.0338 | 0.0876 |

## Death Cause Analysis

| Cause | Count | % | Avg Steps | Avg Reward |
|-------|-------|---|-----------|------------|
| Wall | 16 | 0.1% | 555.5 | 1827.2 |
| SnakeCollision | 10751 | 88.2% | 323.0 | 915.3 |
| MaxSteps | 1416 | 11.6% | 804.4 | -1003.5 |
...
**Total consultations:** 41  
**Most adjusted:** `enemy_proximity_penalty` (35x), `death_snake` (32x), `enemy_approach_penalty` (28x), `epsilon_target` (5x), `lr` (5x), `gamma` (1x), `length_bonus` (1x)
