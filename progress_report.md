...
**Generated:** 2026-03-06 15:32:16  
**Total Episodes:** 46677  
...
### Critical Issues
- Rewards DECLINING: -4544.7

### Warnings
- Loss very high (2846.28) - unstable
...
| S5 | MASTERY_SURVIVAL | 17051 | -3885.4 | 431.2 | 114.8 | 0.5107 | 0.3% | 99.6% | 0.0% |

## Key Statistics

| Metric | Mean | Std | Min | P25 | Median | P75 | P95 | Max |
|--------|------|-----|-----|-----|--------|-----|-----|-----|
| Reward | -58.20 | 172242.18 | -18203767.65 | 329.98 | 868.85 | 2181.26 | 7929.23 | 166636.02 |
| Steps | 412.09 | 1302.33 | 1.00 | 102.00 | 237.00 | 510.00 | 1412.00 | 99999.00 |
| Food | 128.14 | 136.22 | 0.00 | 46.00 | 85.00 | 159.00 | 396.00 | 4532.00 |
| Loss | 9286744.34 | 109947822.87 | 0.00 | 17.40 | 91.91 | 548.75 | 17100790.00 | 12494751744.00 |
...
|--------|-----------|-----|-------|----|
| Last 50 | 2411.91 | 2294.72 | -50.6305 | 0.1014 |
| Last 100 | 2749.27 | 2447.51 | -18.5520 | 0.0479 |
| Last 200 | 2372.59 | 2132.85 | +3.2736 | 0.0079 |
| Last 500 | 2225.37 | 2067.80 | +0.9580 | 0.0045 |
| Last 1000 | 2277.18 | 2271.86 | +0.0600 | 0.0001 |

## Death Cause Analysis

| Cause | Count | % | Avg Steps | Avg Reward |
|-------|-------|---|-----------|------------|
| Wall | 105 | 0.2% | 662.1 | 3417.5 |
| SnakeCollision | 44464 | 95.3% | 359.6 | 2075.4 |
...
**Most adjusted:** `lr` (55x), `enemy_proximity_penalty` (42x), `death_snake` (33x), `enemy_approach_penalty` (33x), `food_reward` (22x), `gamma` (19x), `length_bonus` (17x), `epsilon_target` (9x), `food_shaping` (9x), `survival` (7x), `boost_penalty` (7x), `target_update_freq` (2x), `wall_proximity_penalty` (1x)
