...
**Generated:** 2026-02-22 04:41:22  
**Total Episodes:** 18539  
...
### Warnings
- Loss very high (70.11) - unstable

### Positive Signals
- Rewards improving: +2662.7
- Positive reward trend (slope=0.2784, R²=0.114)
...
| S4 | MASS_MANAGEMENT | 14111 | 1986.3 | 438.9 | 137.4 | 0.5346 | 0.2% | 96.5% | 3.3% |

## Key Statistics

| Metric | Mean | Std | Min | P25 | Median | P75 | P95 | Max |
|--------|------|-----|-----|-----|--------|-----|-----|-----|
| Reward | 1582.67 | 4403.19 | -35299.32 | 244.13 | 628.17 | 1658.93 | 6630.98 | 110327.55 |
| Steps | 398.65 | 437.55 | 1.00 | 110.00 | 260.00 | 512.00 | 1408.10 | 2000.00 |
| Food | 125.26 | 130.40 | 0.00 | 49.00 | 85.00 | 153.00 | 387.00 | 1669.00 |
| Loss | 28.08 | 41.79 | 0.00 | 4.46 | 11.90 | 34.38 | 108.77 | 1097.61 |
| Food/Step | 0.54 | 0.76 | 0.00 | 0.29 | 0.35 | 0.49 | 1.23 | 17.38 |

## Windowed Trend Analysis

| Window | Mean Reward | Std | Slope | R² |
|--------|-----------|-----|-------|----|
| Last 50 | 10527.50 | 16758.14 | -43.5776 | 0.0014 |
| Last 100 | 12386.28 | 17560.45 | -68.3877 | 0.0126 |
| Last 200 | 8699.64 | 14465.07 | +45.1520 | 0.0325 |
| Last 500 | 6984.51 | 13596.85 | +15.5253 | 0.0272 |
| Last 1000 | 6046.49 | 11517.04 | +4.2334 | 0.0113 |
...
| SnakeCollision | 16957 | 91.5% | 353.0 | 1646.2 |
| MaxSteps | 1540 | 8.3% | 900.6 | 881.3 |
...
**Most adjusted:** `enemy_proximity_penalty` (39x), `death_snake` (33x), `enemy_approach_penalty` (31x), `lr` (21x), `gamma` (8x), `food_reward` (8x), `length_bonus` (7x), `epsilon_target` (6x), `survival` (2x), `boost_penalty` (2x), `food_shaping` (2x), `wall_proximity_penalty` (1x)
