...
STYLES = {
    "Standard (Curriculum)": {
        ...
        "stages": {
            1: {
                ...
                "wall_proximity_radius": 2000,
                "enemy_proximity_penalty": 0.0,
                "enemy_proximity_radius": 1200,
                "max_steps": 300,
    ...
    "Aggressive (Hunter)": {
        ...
        "config": {
            ...
            "straight_penalty": 0.0,
            "length_bonus": 0.0,
            "wall_proximity_penalty": -0.6,
            "wall_proximity_radius": 2000,
            "enemy_proximity_penalty": -0.4,
            "enemy_proximity_radius": 1000,
            "max_steps": 99999,
        }
    },
    "Defensive (Safe)": {
        ...
        "config": {
            ...
            "wall_proximity_radius": 2500,
            "enemy_proximity_penalty": -1.0,
            "enemy_proximity_radius": 1500,
            "max_steps": 99999,
        }
    },
    "Explorer (Anti-Float)": {
